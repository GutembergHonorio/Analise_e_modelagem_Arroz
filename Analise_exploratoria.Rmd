...
hist(Centro_oeste$FLO_M, main= "Data de florescimento não regionalizado")
hist(Centro_oeste$FLO_M, main= "Data de florescimento para região Centro-oeste")
hist(Norte$FLO_M, main= "Data de florescimento  para região Norte")
hist(Nordeste$FLO_M, main= "Data de florescimento  para região Nordeste")
hist(Sul$FLO_M, main= "Data de florescimento  para região Sul")
hist(Sudeste$FLO_M, main= "Data de florescimento  para região Sudeste")
