...
a=Tmin_Maxima
  a = a[a$Tmin_Maxima<=28,]

b=Tmin_ACC_R
  b = b[b$Tmin_ACC_R<=1300,]

c=Tmin_ACC_V
  c = c[c$Tmin_ACC_V<=1700,]
  c = c[c$Tmin_ACC_V>=850,]

d=Chuva_ACC_R
  d = d[d$Chuva_ACC_R<=600,]
...
test1<-ggplot(a, mapping = aes(x=Tmin_Maxima, y=FLO))+
 geom_point( col ="dodgerblue4")+
    scale_y_continuous(limits = c(70, 92))+
...
```{r}
((test6|test4|test1)/(test2|test3))+plot_annotation(tag_levels = 'A', tag_prefix = '(', tag_suffix = ')')
```
