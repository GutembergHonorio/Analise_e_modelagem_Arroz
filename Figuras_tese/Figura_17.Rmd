...
trt[["plots"]][[4]][["ggObj"]][["labels"]][["x"]]<-c("Degree_days_FLO (ºC)")
...
a<-ggplot(mydf, aes(x, predicted)) +
  ...
  labs(y = "Flowering (DAE)",  x ="Tmin_R (ºC)", title = "(A)")+
  theme_classic()
...
b<-ggplot(mydf, aes(x, predicted)) +
  geom_line(color = "blue") +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = .1)+
  labs(y = "Flowering (DAE)",  x ="Tmin_V (ºC)", title = "(B)")+
  theme_classic()
...
c<-ggplot(mydf, aes(x, predicted)) +
  geom_line(color = "blue") +
  geom_ribbon(aes(ymin = conf.low, ymax = conf.high), alpha = .1)+
  labs(y = "Flowering (DAE)",  x ="Tmin_ACC_V (ºC)", title = "(C)")+
  theme_classic()
