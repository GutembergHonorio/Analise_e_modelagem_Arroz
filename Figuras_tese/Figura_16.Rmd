...
a=Tmax_ACC_R
  a=a[a$Tmax_ACC_R<=1800,]
  a=a[a$Tmax_ACC_R>=800,]

b=Chuva_ACC_V
c=Tmax_R
d=Tmax_V
e=Tmax_ACC_V
  e=e[e$Tmax_ACC_V>=1200,]
  e=e[e$Tmax_ACC_V<=2300,]
...
# Figura 16
```{r}
((test4|test3|test1)/(test5|test2))+plot_annotation(tag_levels = 'A', tag_prefix = '(', tag_suffix = ')')
